...
describe('OrderedListSkeleton Tests', () => {
    /** Default test, makes sure the skeleton renders */
    it('renders', () => {
        const { getByTestId } = render(
            <OrderedListSkeleton data-testid='skeleton' />
        )
    ...
    it('should animate', () => {
        const { getByTestId } = render(
            <OrderedListSkeleton animate={true} data-testid='skeleton-animate' />
        )
    ...
    it('should change in width', () => {
        const { getByTestId } = render(
            <OrderedListSkeleton width='30rem' data-testid='skeleton-width' />
        )
    ...
    it('should have more list items', () => {
        const { getByTestId } = render(
            <OrderedListSkeleton items='7' data-testid='skeleton-items' />
        )
    ...
    it('should have more list items', () => {
        ...
        densities.forEach(density => {
            const { getByTestId } = render(
                <OrderedListSkeleton density={density} data-testid={`skeleton-${density}`} />
            )

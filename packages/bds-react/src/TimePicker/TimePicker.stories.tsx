...
export default { title: '@lowes-tech/bds-react/TimePicker', decorators: [withKnobs] }
...
export const Skeleton = () => (
    <Grid.Column start={6} end={12}>
        <FormControl>
            <FormHeading>TimePicker Skeleton</FormHeading>
            <br />
            <TimePickerSkeleton
                shape={select(...shapes)}
                size={select(...sizes)}
        ...
        <br />
        <FormControl>
            <FormHeading>TimePicker Skeleton w/ Helper Text</FormHeading>
            <br />
            <TimePickerSkeleton
                shape={select(...shapes)}
                size={select(...sizes)}

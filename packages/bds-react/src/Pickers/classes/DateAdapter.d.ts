interface DateAdapterFormats<TLibFormatToken = string> {
    /** Default date @example 1993-05-12å */
    default: TLibFormatToken
...
interface DateAdapterInterface<TDate> {
    formats: DateAdapterFormats<any>
    locale?: any
    moment?: any
    dayjs?: any

    // constructor (options?: { formats?: DateAdapterFormats, locale?: any, instance?: any });
    ...
    /** 
     * Returns user readable format (taking into account localized format tokens), 
     * useful to render helper text for input (e.g. placeholder). 
     * For luxon always returns empty string. 
     */
    ...
    format(value: TDate, formatKey: keyof DateAdapterFormats): string

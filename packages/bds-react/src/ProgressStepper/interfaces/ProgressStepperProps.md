...
- `BackyardBaseProps`<[`ProgressStepperRef`](../README.md#progressstepperref), `ProgressStepperOverrideProps`\>
...
• `Optional` **connector**: `ReactElement`<`any`, `string` \| `JSXElementConstructor`<`any`\>\>

...
const Affirm: React.ForwardRefExoticComponent<AffirmProps> = React.forwardRef<AffirmRef, AffirmProps>(
    function Affirm({ color, size, className, ...props }, ref) {
        return (
            <PathIcon
